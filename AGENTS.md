...
- Top Performers: keep endpoint metrics/weights as documented (throughput, completion%, cycle time, blocker rate; consistency/update coverage displayed; low-sample guard) unless explicitly requested to change. Admin-only access.
